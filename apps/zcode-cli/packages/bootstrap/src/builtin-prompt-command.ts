...
function buildInitAgentsPrompt(params: {
  ...
  return [
    "You are running Y Code's built-in /init command.",
    "",
    "Your task is to create or update a concise workspace instruction file for future Y Code agents.",
    "",
    "Target:",
    ...
    "6. Include only project-specific facts future Y Code agents would otherwise miss.",
