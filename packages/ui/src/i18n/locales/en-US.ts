...
const enUS: Record<string, string> = {
  ...
  "settings.modelProvider.opencodeUsage.cookieLabel": "Cookie header",
  ...
  "login.title": "Welcome to YCode",
  "login.description": "Connect your account to start using YCode",
  ...
  "logout.confirm.title": "Disconnect and restart YCode?",
  ...
  "planDirectory.title": "Plans",
  "planDirectory.loading": "Loading plans…",
  ...
  "modelTrajectory.systemPromptBlock": "System prompt (request-level system param)",
  "modelTrajectory.role.systemReminder": "System reminder (runtime-injected)",
  "modelTrajectory.role.systemInjected": "System message (runtime-injected)",
  "modelTrajectory.wireRoleNote": "sent as {role} on the wire",
  ...
  "settings.modelProviderTitle": "Providers and models",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to YCode 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by YCode automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in YCode.",
  ...
  "sidebar.usage.plan.zcodeMcpDescription": "Daily aggregate quota for YCode built-in plugin MCPs",
  ...
  "chat.toolCall.kind.getContextUsage": "Get context usage",
  "chat.toolCall.kind.listPlans": "List plans",
  "chat.toolCall.listPlans.reading": "Reading plans",
  "chat.toolCall.listPlans.found": "Found {count} plans",
  "chat.toolCall.listPlans.empty": "No plans",
  "chat.toolCall.listPlans.openDirectory": "Open plan directory",
  "chat.toolCall.getContextUsage.reading": "Reading context usage",
  "chat.toolCall.getContextUsage.unavailable": "Data unavailable",
  "chat.toolCall.getContextUsage.remainingSummary": "{percent} remaining",
  "chat.toolCall.getContextUsage.effectiveUsage": "Used / effective window",
  "chat.toolCall.getContextUsage.progress": "Context usage progress",
  "chat.toolCall.getContextUsage.used": "Used",
  "chat.toolCall.getContextUsage.remaining": "Remaining",
  "chat.toolCall.getContextUsage.effectiveWindow": "Effective context window",
  "chat.toolCall.getContextUsage.autoCompactThreshold": "Auto-compact threshold",
  "chat.toolCall.getContextUsage.contextWindow": "Full context window",
  "chat.toolCall.getContextUsage.tokenSource": "Token source",
  "chat.toolCall.getContextUsage.source.providerUsage": "Provider usage",
  "chat.toolCall.getContextUsage.source.estimate": "Local estimate",
  "chat.toolCall.getContextUsage.invalidResult":
    "This call has no valid structured context usage data.",
  ...
  "chat.toolCall.turnSummary.explore.one": "{count} explore call",
  "chat.toolCall.turnSummary.explore.other": "{count} explore calls",
  "chat.toolCall.turnSummary.terminal.one": "{count} terminal call",
  "chat.toolCall.turnSummary.terminal.other": "{count} terminal calls",
  "chat.toolCall.turnSummary.changes.one": "{count} edit",
  "chat.toolCall.turnSummary.changes.other": "{count} edits",
  "chat.toolCall.turnSummary.reasoning.one": "{count} thought",
  "chat.toolCall.turnSummary.reasoning.other": "{count} thoughts",
  ...
  "chat.toolCall.sendMessage.targetFallback": "Target subagent",
  ...
  "chat.toolCall.taskStop.titleFallback": "Stop task",
  "chat.toolCall.taskStop.resultStopped": "Task stopped",
  "chat.toolCall.taskStop.resultStoppedTask": "Task stopped: {title}",
  ...
  "chat.quota.mcp.quotaExhausted":
    'YCode MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No YCode MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  "chat.elicitation.skip": "Skip",
  "chat.elicitation.discardDrafts.title": "Discard your answers?",
  "chat.elicitation.discardDrafts.description":
    "Discarding marks every question as unanswered. What you typed is not kept and the model will not see it.",
  "chat.elicitation.discardDrafts.confirm": "Discard answers",
  "chat.elicitation.discardDrafts.cancel": "Keep editing",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while YCode is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task YCode can work on in the background, including the expected result and any constraints…",
